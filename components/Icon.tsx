    ...
    case 'verified':
      return (
        <svg
          ...
          fill="currentColor"
        >
          <path d="M12 2l2.09 2.09L16.5 3.5l.91 2.41L20 7l-1.09 2.09L20.5 11l-2.41.91-.91 2.41-2.41-.59L12 18l-2.09-2.09-2.41.59-.91-2.41L4.5 11 6.09 9.09 5 7l2.59-.09L8.5 3.5l2.41.59L12 2zm-1.2 11.4l4.3-4.3-1.4-1.4-2.9 2.89-1.3-1.29-1.4 1.41 2.7 2.69z" />
        </svg>
      );
    case 'attach_money':
      return (
